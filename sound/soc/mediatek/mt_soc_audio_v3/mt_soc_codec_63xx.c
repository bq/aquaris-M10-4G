...
//add external headphone amp xmysx 20160905
#ifdef CONFIG_SND_SOC_TPA6130A2
#include "../../codecs/tpa6130a2.h"
#endif
//add external headphone amp xmysx 20160905 end
...
{
	#ifdef CONFIG_SND_SOC_TPA6130A2
	tpa6130a2_stereo_enable(NULL, enable);
	#endif
}
#endif
//add external headphone amp xmysx 20160905 end
...
//add control for ext hp amp power pin xmysx20161020
#ifdef CONFIG_EXT_HP_AMP
...
static const struct snd_kcontrol_new mt6331_snd_controls[] = {
	...
	//add control for ext hp amp power pin xmysx20161020
#ifdef CONFIG_EXT_HP_AMP
	SOC_ENUM_EXT("Ext_Headphone_Amp_Switch", Audio_DL_Enum[11], Ext_Headphone_Amp_Get,
